...
//         {/* Back Button */}
//         {/* product_sanity to Home */}
//         <Link href="/products_sanity" className="inline-flex items-center gap-2 text-blue-600 hover:text-blue-700 font-semibold mb-6">
...
// src/app/products_sanity/[slug]/ProductDetailClient.tsx
"use client";
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="bg-slate-50 rounded-lg p-4 border border-slate-200">
              <p className="text-xs font-semibold text-slate-700 mb-2 uppercase">
                About This Design
              </p>
              <p className="text-sm text-slate-600 leading-relaxed">
                {product.description || "No description available"}
            ...
            {/* Contact Links */}
            <div className="bg-slate-50 rounded-lg p-4 border border-slate-200">
              <p className="text-xs font-semibold text-slate-700 mb-3 uppercase">
                Contact Us
              </p>
              <div className="grid grid-cols-2 gap-3">
                {/* Discord */}
